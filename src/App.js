...
const tld = ".juilli";
const CONTRACT_ADDRESS = "0x837d0FCad1e9E9dA9373CB99A105201dAbC20a7b";
...
const App = () => {
  ...
  const renderNotConnectedContainer = () => (
    <div className="connect-wallet-container">
      <img
        src="http://keiopress.coolblog.jp/juilliard_guitar.png"
        alt="juilliard guitar"
        width = "250px"
        height = "250px"
      />
    ...
    return (
      <div className="form-container">
        ...
        <input
          type="text"
          value={record}
          placeholder='whats ur juilli power?'
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">🎹 Juilli Name Service</p>
